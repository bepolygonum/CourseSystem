                ...
                <div class="">
                    ...
                    <#if student.getEmail()?exists>
                        <div>
                            ...
                            <div class="myDiv">
                                <label class="myLabel">${student.getEmail()}</label><br>
                    ...
                    <a class="am-btn am-btn-success am-radius am-button" style="margin-top: 3rem; float: right;" type="submit" href="/">退出登录
                    </a>
                </div>
            </div>
        </div>
